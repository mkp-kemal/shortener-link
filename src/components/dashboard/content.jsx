                        ...
                        <div className="bg-blue-50 dark:bg-gray-800 transition-colors duration-500 ease-in-out shadow-2xl p-5 rounded-lg">
                            ...
                            <form className="space-y-4 dark:text-white transition-colors duration-500 ease-in-out" onSubmit={handleShorten}>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex justify-center w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300 disabled:opacity-50"
                                >
                                    {loading ?
                                        <>
                    ...
                    <div className="flex-1">
                        <div className="bg-gray-50 dark:bg-gray-800 transition-colors duration-500 ease-in-out shadow-2xl p-5 rounded-lg">
                            ...
                            {shortenedResult ? (
                                ...
                                <div className="bg-white dark:bg-gray-800 transition-colors duration-500 ease-in-out p-8 text-center rounded-md border-2 border-dashed border-gray-200 dark:border-gray-600">
